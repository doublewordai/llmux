...
## [0.9.1](https://github.com/doublewordai/llmux/compare/v0.9.0...v0.9.1) - 2026-02-20

### Fixed

- expand MXFP4 reload patch to cover Triton, SM100, and SM90 backends

## [0.9.0](https://github.com/doublewordai/llmux/compare/v0.8.0...v0.9.0) - 2026-02-20

### Fixed

- prevent orphaned vLLM process on switch cancellation
...
- open log files with O_APPEND for checkpoint persistence

## [0.7.12](https://github.com/doublewordai/llmux/compare/v0.7.11...v0.7.12) - 2026-02-20

### Fixed

- exclude parent process from TP size calculation

## [0.7.11](https://github.com/doublewordai/llmux/compare/v0.7.10...v0.7.11) - 2026-02-20

### Fixed

- separate tp_size from CUDA process count

### Other

- move config files into configs/ directory
